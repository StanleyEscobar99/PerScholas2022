...
//i is ittarater its only a place holder
...
// //Anton Solution
// const sumOfSat=(planetOne,planetTwo,planetThree,planetFour)=>{
//     //     let sum=0
...
//     // sum = planetOne+planetTwo+planetThree+planetFour
    
//     // console.log(sum)
//     return parseInt(planetOne)+parseInt(planetTwo)+parseInt(planetThree)+parseInt(planetFour)
//     }
// console.log(sumOfSat(system.jupiter.satellites,system.saturn.satellites,system.uranus.satellites,system.neptune.satellites))
...
// let plutoMomentum = system
m.pluto.velocity * system.pluto.mass
// console.log(jupiterMomentum)
// let momentum = jupiterMomentum - plutoMomentum
